...
class AppManager:
    ...
    def __init__(self, root: tk.Tk, user_id: str = None, device_id: str = None):
        # Guardamos los IDs para uso posterior si lo necesitas
        ...
        # Configurar protocolo de cierre para que solo cierre cuando sea desde la ventana principal
    ...
    def _on_closing(self):
        ...
        # Cerrar la aplicación solo cuando se cierra desde la ventana principal
        self.root.quit()
        self.root.destroy()
    ...
    def open_violation_window(self):
        ...
        # Si más adelante create_violation_window acepta IDs,
        # aquí podrías pasárselos: create_violation_window(self.root, self.show_welcome, self.user_id, self.device_id)
    ...
    def open_infractions_window(self):
        ...
        # De igual modo, si quisieras pasar user_id a la ventana de infracciones:
        # create_infractions_window(self.root, self.show_welcome, self.user_id)
